document.addEventListener('DOMContentLoaded', () => {
    ...
    // Contoh data cerita (akan diganti dengan data dari backend)
    const story = {
        start: {
        ...
        // Tambahkan lebih banyak skenario di sini
        cross_river: {
        ...
        find_detour: {
            ...
            choices: [
                ...
                { text: "Kembali ke sungai dan menyeberanginya.", next: "cross_river" } // Kembali ke skenario sebelumnya
            ]
        },
        approach_sound: {
    ...
    function displayScene(sceneKey) {
        ...
        if (!scene) {
            storyTextElement.textContent = "Terjadi kesalahan: Skenario tidak ditemukan.";
            choicesElement.innerHTML = '';
            return;
        }

        storyTextElement.textContent = scene.text;
        choicesElement.innerHTML = ''; // Bersihkan pilihan sebelumnya
